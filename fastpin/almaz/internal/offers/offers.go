...
func NewOffersHandler(router *http.ServeMux, deps OffersshandlerDeps) *OffersHandler {
	...
	router.Handle("/offers/create", deps.AdminMW(http.HandlerFunc(handler.create())))
	router.Handle("/offers/updateOffer", deps.AdminMW(http.HandlerFunc(handler.updateOffer())))
	router.Handle("/offers/deleteOffer", deps.AdminMW(http.HandlerFunc(handler.deleteOffer())))
	return handler
}
