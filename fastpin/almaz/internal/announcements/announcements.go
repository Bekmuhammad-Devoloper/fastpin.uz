...
func NewOffersHandler(router *http.ServeMux, deps AnnouncementshandlerDeps) *AnnouncementsHandler {
	...
	router.Handle("/announcements/create", deps.AdminMW(http.HandlerFunc(handler.create())))
	router.Handle("/announcements/update", deps.AdminMW(http.HandlerFunc(handler.update())))
	router.Handle("/announcements/delete", deps.AdminMW(http.HandlerFunc(handler.delete())))
	return handler
}
